...
<div class="row mb-2">
  <div class="col-10">
    <form class="form-inline" action="" method="POST">
      <input class="form-control mr-sm-2" type="search" placeholder="Tìm kiếm slider" aria-label="Search" style="width: 25%">
      <select class="form-control mr-2" id="category" name="category_id">
        <option value="" selected="">Xem tất cả slider</option>
...
@include('backend.sliders.list')
  ...
  <a href="{{ route($controllerName.'.create') }}" class="btn btn-success" >Thêm slider</a>
